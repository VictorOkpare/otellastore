  ...
  return (
    <>
      <div className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-white flex justify-center items-center dark:bg-black dark:text-white duration-200'>
        {/* background pattern */}
        <div className="h-[600px] w-[300px] max-sm:h-[150px] max-sm:w-[1000px] bg-orange-500 dark:bg-orange-500 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-9 ">
        </div>
        {/* hero section */}
        <div className='container sm:pb-0' data-aos='zoom-out' data-aos-duration='500' data-aos-once='true'>
          <Slider {...settings}>
            {ImageList.map((data) => (
              <div key={data.id}>
                <div className='grid grid-cols-1 sm:grid-cols-2'>
                  ...
                  <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                    <h1 data-aos='zoom-out' data-aos-duration='500' data-aos-once='true' className='text-black text-5xl sm:text-6xl lg:text-7xl font-bold dark:text-white'>
                      {data.title}
                    </h1>
                    <p data-aos='zoom-out' data-aos-duration='500' data-aos-once='true' className="text-sm text-black font-bold dark:text-orange-500 dark:max-sm:text-white">
                      {data.description}
                    </p>
                    <div data-aos='zoom-out' data-aos-duration='700' data-aos-once='true'>
