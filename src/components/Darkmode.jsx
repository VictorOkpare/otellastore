...
const Darkmode = () => {
  ...
  return (
    ...
    <div className='relative'>
      ...
      <MdOutlineDarkMode className='w-12 cursor-pointer drop-shadow[1px_1px_1px_rgba(0,0,0,0.1) transition-all duration-300 ]' onClick={() => setTheme(theme === "light" ? "dark" : "light")}/>
    </div>
  )
}
